const gifts = [
  ...
  {
    name: '礼物 2 · 有了裙子怎么可以没有项链呢~',
    desc: '把闪闪发光的小心意挂在胸前，也把我的偏爱戴在身上。',
    image: 'images/项链.jpg'
  },
  {
    name: '礼物 3 · 威力巨大的高速粒子吹风机！',
    desc: '把头发吹得顺顺滑滑，也希望你每天都轻轻松松。',
    image: 'images/吹风机.jpg'
  },
  {
    name: '礼物 4 · 新的抱枕小狗狗~',
    desc: '抱着它的时候，就像把软乎乎的小幸福也一起抱住啦。',
    image: 'images/小狗.jpg'
  },
  {
    name: '礼物 5 · 给最爱的人购买费列罗巧克力！',
    desc: '甜甜的巧克力，送给甜甜的你。',
    image: 'images/费列罗.jpg'
  },
  {
    name: '礼物 6 · 淡雪草莓送我最爱滴宝宝！',
    desc: '想把草莓的清甜和我的喜欢一起打包送给你。',
  ...
  {
    name: '礼物 8 · 神秘大奖',
    desc: '压轴惊喜当然要神秘一点：请你本人来开启最终解释权。',
    image: createGiftSvg('惊喜', ['#ead9ff', '#9f7bff'])
  }
];
